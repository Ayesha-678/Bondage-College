...
var AssetFemale3DCG = [
...

	{
			...
			{ Name: "CowPrintedBra", Value: 15, Hide: ["ItemNipples", "ItemNipplesPiercings"] },
      {
			...
			{ Name: "Ribbon", Value: 25, BuyGroup: "Ribbon", DefaultColor: "#B41E1E", Extended: true, AllowType: ["TightSingleStrip", "Bra", "StraplessBra", "Swimsuit1", "Swimsuit2", "FrameBra", "Bikini"] },
...

	{
		...
		Asset: [
			...
			{ Name: "Ribbon", Value: 25, BuyGroup: "Ribbon",  Effect: ["BlindLight", "Prone"], DefaultColor: "#B41E1E", Extended: true, AllowType: ["FaceWrap", "FaceWrapOpenEyes", "FaceWrapOpenMouth","Hood"] },
			AssetSpankingToys
		],
		Color: ["Default", "#202020", "#808080", "#bbbbbb", "#aa8080", "#80aa80", "#8080aa", "#aaaa80", "#80aaaa", "#aa80aa", "#cc3333", "#33cc33", "#3333cc", "#cccc33", "#33cccc", "#cc33cc"]
	},
