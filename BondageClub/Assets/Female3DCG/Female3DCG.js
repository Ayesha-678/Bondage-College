...
var AssetFemale3DCG = [
	...
	// Appearance specific
	{
		...
		Asset: [
			...
			{ Name: "WardenOutfit", Value: 1, DefaultColor: "#5F7690" }
		],
...

	{
		...
		Asset: [
			...
			{ Name: "WardenTie", Value: 1, DefaultColor: "#202020", Priority: 34, Left: 173, Top: 240 }			
		],
		Color: ["Default", "#202020", "#808080", "#bbbbbb", "#aa8080", "#80aa80", "#8080aa", "#aaaa80", "#80aaaa", "#aa80aa", "#cc3333", "#33cc33", "#3333cc", "#cccc33", "#33cccc", "#cc33cc"]
	},
...

	{
		...
		Asset: [
			...
			{ Name: "PrisonStraitJacket", DefaultColor: ["#CF721D","#CF721D","#CF721D", "#75502B", "#bbbbbb", "#75502B", "#75502B", "#75502B",], Value: 1, Priority: 25, Difficulty: 4, SelfBondage: 2, Time: 45, RemoveTime: 30, Random: false, AllowLock: true, DrawLocks: false, Hide: ["Cloth", "ItemNipplesPiercings"], SetPose: ["BackElbowTouch"], Effect: ["Block", "Prone"],
				AllowBlock: ["ItemNipples", "ItemNipplesPiercings", "ItemTorso", "ItemBreast", "ItemHands", "ItemVulva", "ItemVulvaPiercings", "ItemButt", "ItemPelvis"],
				Block: ["ItemNipples", "ItemNipplesPiercings", "ItemTorso", "ItemBreast", "ItemHands"],
				Extended: true,
				Layer: [
					...
					{ Name: "BasicBodyStrapsLoose", AllowModuleTypes: ["a0b1"], HasType: false },
					{ Name: "IntricateBodyStrapsLoose", CopyLayerColor: "BasicBodyStrapsLoose", AllowModuleTypes: ["a0b2"], HasType: false },
					{ Name: "ExtremeBodyStrapsLoose", CopyLayerColor: "BasicBodyStrapsLoose", AllowModuleTypes: ["a0b3"], HasType: false },
					{ Name: "BasicBodyStrapsFront", CopyLayerColor: "BasicBodyStrapsLoose", AllowModuleTypes: ["a1b1"], HasType: false },
					{ Name: "BasicBodyStrapsBack",  CopyLayerColor: "BasicBodyStrapsLoose", AllowModuleTypes: ["a2b1"], HasType: false },
					{ Name: "BasicBodyStrapsSheathFront",  CopyLayerColor: "BasicBodyStrapsLoose", AllowModuleTypes: ["a7b1"], HasType: false },
					{ Name: "BasicBodyStrapsSheathBack",  CopyLayerColor: "BasicBodyStrapsLoose", AllowModuleTypes: ["a8b1"], HasType: false },
